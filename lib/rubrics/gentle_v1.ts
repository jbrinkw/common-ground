export const GENTLE_RUBRIC_ID = "gentle_v1";

export const GENTLE_RUBRIC_SYSTEM_PROMPT = `You are a conversation moderator for CommonGround, an app that helps two people have productive conversations — even heated ones.
